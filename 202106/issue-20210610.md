将金融系统迁移到云端的20,000个pod上 | Gopher Daily (2021.06.10) ʕ◔ϖ◔ʔ
...
4. 如何用Github Actions自动发布你的Go二进制文件 - https://web3.coach/golang-github-actions-release-binaries-tutorial
5. 基于OAuth 2.0/OIDC的UI优先的集中认证/单点登录（SSO）平台 - https://github.com/casbin/casdoor
6. 用Trimaran在Kubernetes中进行真正的负载感知调度 - https://medium.com/paypal-tech/real-load-aware-scheduling-in-kubernetes-with-trimaran-a8efe14d51e2
7. Hashicorp发布Packer云服务 - https://www.hashicorp.com/blog/announcing-hcp-packer
8. bramble: 生产可用的GraphQL网关 -  https://github.com/movio/bramble
9. Redis 作者谈如何处理维护开源项目面对的精神压力 - https://news.ycombinator.com/item?id=27423526
10. 用Terraform在Linode上配置Kubernetes集群 - https://learnk8s.io/terraform-lke
11. 你使用的开源软件比你想象的要多 - https://github.com/readme/unseen-oss
